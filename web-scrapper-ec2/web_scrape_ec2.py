...
import pandas as pd
from ec2_connection import Migration
...
class scrapper(Migration):
    ...
    def __init__(self):
        ...
        self.url = 'https://www.myprotein.com/nutrition/vitamins-minerals.list'
    ...
    def accept_cookies(self):
        try:            
            accept_cook= self.driver.find_element(By.XPATH,'//*[@id="home"]/div[6]/div/div[2]/button')
            accept_cook.click()
        except:
            pass
            
    def accept_second_cookies(self):
        try:            
    ...
    #         s3 = boto3.client('s3')
    #         bucket_name = 'aicorbuc'
    #         files_in_image_folder = glob.glob('raw_data\\images\\*')
    ...
    def get_all_product(self):
        ...
        for products in all_product:
            ...
            #     product_unik_path = f'raw_data\\{product_unik}'
